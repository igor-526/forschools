...
class MaterialListUserNavigationCallback(CallbackData,
                                         prefix="mat_list_user"):
    page: int
    user_id: int


class MaterialListHomeworkNavigationCallback(CallbackData,
                                             prefix="mat_list_homework"):
    page: int
    hw_id: int
