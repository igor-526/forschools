...
from tgbot.keyboards.callbacks.material import (
    MaterialCategoryCallback,
...
def get_keyboard_query_user(materials: list,
                            user_id: int,
                            current_page=1,
                            next_button=False) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    adjust_grid = [1]
...
def get_keyboard_query_hw(materials: list,
                          hw_id: int,
                          current_page=1,
                          next_button=False) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
...
def get_keyboard_material_item(material,
                               delete_settings=None) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
