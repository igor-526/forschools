...
class Command(BaseCommand):
    ...
    def add_auth_perms(self):
        ...
        register_admin = Permission.objects.get_or_create(
            codename="register_admin",
            name="Регистрация администраторов",
            content_type=content_type
        )[0]
        register_metodist = Permission.objects.get_or_create(
            codename="register_metodist",
            name="Регистрация методистов",
            content_type=content_type
        )[0]
        register_teacher = Permission.objects.get_or_create(
            codename="register_teacher",
            name="Регистрация преподавателей",
            content_type=content_type
        )[0]
        register_listener = Permission.objects.get_or_create(
            codename="register_listener",
            name="Регистрация учеников",
            content_type=content_type
        )[0]
        register_curator = Permission.objects.get_or_create(
            codename="register_curator",
            name="Регистрация кураторов",
            content_type=content_type
        )[0]
        register_users = Permission.objects.get_or_create(
            codename="register_users",
            name="Регистрация пользователей",
            content_type=content_type
        )[0]
        edit_admin = Permission.objects.get_or_create(
            codename="edit_admin",
            name="Изменение информации администратора",
            content_type=content_type
        )[0]
        edit_metodist = Permission.objects.get_or_create(
            codename="edit_metodist",
            name="Изменение информации методиста",
            content_type=content_type
        )[0]
        edit_teacher = Permission.objects.get_or_create(
            codename="edit_teacher",
            name="Изменение информации преподавателя",
            content_type=content_type
        )[0]
        edit_curator = Permission.objects.get_or_create(
            codename="edit_curator",
            name="Изменение информации куратора",
            content_type=content_type
        )[0]
        edit_listener = Permission.objects.get_or_create(
            codename="edit_listener",
            name="Изменение информации ученика",
            content_type=content_type
        )[0]
        deactivate_admin = Permission.objects.get_or_create(
            codename="deactivate_admin",
            name="Деактивация администратора",
            content_type=content_type
        )[0]
        deactivate_metodist = Permission.objects.get_or_create(
            codename="deactivate_metodist",
            name="Деактивация методиста",
            content_type=content_type
        )[0]
        deactivate_teacher = Permission.objects.get_or_create(
            codename="deactivate_teacher",
            name="Деактивация преподавателя",
            content_type=content_type
        )[0]
        deactivate_listener = Permission.objects.get_or_create(
            codename="deactivate_listener",
            name="Деактивация ученика",
            content_type=content_type
        )[0]
        see_moreinfo_admin = Permission.objects.get_or_create(
            codename="see_moreinfo_admin",
            name="Доп. информация администратора",
            content_type=content_type
        )[0]
        see_moreinfo_metodist = Permission.objects.get_or_create(
            codename="see_moreinfo_metodist",
            name="Доп. информация методиста",
            content_type=content_type
        )[0]
        see_moreinfo_teacher = Permission.objects.get_or_create(
            codename="see_moreinfo_teacher",
            name="Доп. информация преподавателя",
            content_type=content_type
        )[0]
        see_moreinfo_listener = Permission.objects.get_or_create(
            codename="see_moreinfo_listener",
            name="Доп. информация ученика",
            content_type=content_type
        )[0]
        can_read_all_messages = Permission.objects.get_or_create(
            codename="can_read_all_messages",
            name="Чтение сообщений от имени других пользователей",
            content_type=content_type
        )[0]
        can_login = Permission.objects.get_or_create(
            codename="can_login",
            name="Залогинивание под другими пользователями",
            content_type=content_type
        )[0]
        mailing_access = Permission.objects.get_or_create(
            codename="mailing_access",
    ...
    def add_material_perms(self):
        ...
        add_general = Permission.objects.get_or_create(
            codename="add_general",
            name="Добавление общего материала",
            content_type=content_type_materials
        )[0]
        add_personal = Permission.objects.get_or_create(
            codename="add_personal",
            name="Добавление личного материала",
            content_type=content_type_materials
        )[0]
        add_new_cat = Permission.objects.get_or_create(
            codename="add_new_cat",
            name="Добавление новой категории материалов",
            content_type=content_type_materials
        )[0]
        send_to_moderate = Permission.objects.get_or_create(
            codename="send_to_moderate",
            name="Отправка материалов на модерацию",
            content_type=content_type_materials
        )[0]
        moderate = Permission.objects.get_or_create(
            codename="moderate",
            name="Модерация материалов",
            content_type=content_type_materials
        )[0]
        see_all_general = Permission.objects.get_or_create(
            codename="see_all_general",
            name="Просмотр общих материалов",
            content_type=content_type_materials
        )[0]
        see_not_own = Permission.objects.get_or_create(
            codename="see_not_own",
            name="Просмотр чужих личных материалов",
            content_type=content_type_materials
        )[0]
        see_listener_mat = Permission.objects.get_or_create(
            codename="see_listener_mat",
            name="Просмотр материалов ученика",
            content_type=content_type_materials
        )[0]
        send_telegram = Permission.objects.get_or_create(
            codename="send_telegram",
    ...
    def add_lesson_perms(self):
        ...
        edit_plans_self = Permission.objects.get_or_create(
            codename="edit_plans_self",
            name="Создание/редактирование своих планов обучения",
            content_type=content_type
        )[0]
        edit_plans_all = Permission.objects.get_or_create(
            codename="edit_plans_all",
            name="Создание/редактирование чужих планов обучения",
            content_type=content_type
        )[0]
        see_plans_self = Permission.objects.get_or_create(
            codename="see_plans_self",
            name="Просмотр своих планов обучения",
            content_type=content_type
        )[0]
        see_plans_all = Permission.objects.get_or_create(
            codename="see_plans_all",
            name="Просмотр всех планов обучения",
            content_type=content_type
        )[0]
        comment_lesson = Permission.objects.get_or_create(
            codename="comment_lesson",
            name="Комментирование/оценка занятия",
            content_type=content_type
        )[0]
        see_teachers_comment = Permission.objects.get_or_create(
            codename="see_teachers_comment",
