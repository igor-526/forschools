...
from .views_api import (UserLogsActionsAPIView,
                        UserLogsMessagesByTagAPIVIew,
                        UserLogsMessagesChatAPIVIew,
                        UserLogsMessagesUsersAPIVIew)
...
api_v1_patterns = [
    ...
    path('plan<int:plan_pk>/messages/',
         UserLogsMessagesUsersAPIVIew.as_view()),
    path('plan<int:plan_pk>/messages_tag/',
         UserLogsMessagesByTagAPIVIew.as_view()),
