...
class TGHomework:
    ...
    async def _show_log_item(self, log_id: int):
    ...
    async def send_actions(self, materials_button):
...
def open_homework_in_tg(telegram_id: int, homework_id: int):
