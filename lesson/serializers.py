...
from .permissions import (lesson_perm_can_set_not_held,
                          can_set_passed,
                          lesson_perm_can_set_replace,
                          lesson_perm_can_delete, lesson_perm_can_add_homework, lesson_perm_can_edit)
...
class LessonSerializer(serializers.ModelSerializer):
    ...
    def get_awaiting_action(self, obj) -> str | bool:
        ...
        if ((can_set_passed_ and self.plan and self.plan.can_report_lesson_name_only) or
