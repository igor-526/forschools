...
apiv1patterns = [
    ...
    path('teacherslisteners/', TeacherListenersListAPIView.as_view()),  # API для вывода преподавателей и учеников для фильтрации  занятиях
