...
function setMaterialLevels(){
    ...
    tableBody.innerHTML = '<td>Добавить уровень материалов</td><td><button type="button" class="btn btn-primary" id="TableButtonMatLevelAdd" data-col-id="0"><i class="bi bi-plus-lg"></i></button></td>'
